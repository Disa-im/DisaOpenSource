// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AdmissionSyntax.cs">
...
namespace Raksha.Asn1.IsisMtt.X509
{
    /**
    ...
    */
    ...
    {
        private readonly GeneralName _admissionAuthority;
        private readonly Asn1Sequence _contentsOfAdmissions;
        ...
        */
        ...
        {
            get { return _admissionAuthority; }
        }
        ...
        public override Asn1Object ToAsn1Object()
        {
            ...
            if (_admissionAuthority != null)
            {
                vec.Add(_admissionAuthority);
            }
            vec.Add(_contentsOfAdmissions);
        ...
        */
        ...
        {
            var result = new Admissions[_contentsOfAdmissions.Count];

            for (int i = 0; i < _contentsOfAdmissions.Count; ++i)
            {
                result[i] = Admissions.GetInstance(_contentsOfAdmissions[i]);
            }
