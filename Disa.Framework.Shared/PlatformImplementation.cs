...
namespace Disa.Framework
{
    public abstract class PlatformImplementation
    {
        ...
        public abstract string GetCachedStickersPath();

        public abstract string GetGifsPath();

        public abstract string GetCachedGifsPath();
        ...
        public abstract void DeleteBubbleGroup(BubbleGroup[] bubbleGroups, bool notifyService);
