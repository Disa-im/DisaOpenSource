...
namespace Disa.Framework.Telegram.Mobile
{
    public static class Setup 
    {
            ...
            public UserInformation(Service service, TabbedPage tabs)
            {
                ...
                _finish.Clicked += async (sender, e) =>
                {
                    ...
                    if (result.Success)
                    {
                        ...
                        if (global::Disa.Framework.Platform.DeviceHasApp(TelegramPackage))
                        {
        ...
        private class MuteNotifications : ContentPage
        {
            ...
            {
                global::Disa.Framework.Platform.OpenApp(TelegramPackage);
            }

            private void DisableNotificationsVideo()
            {
                global::Disa.Framework.Platform.LaunchViewIntent("https://www.youtube.com/watch?v=HJVJG7onFb0");
            }
