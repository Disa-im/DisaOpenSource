...
//     Generated at 03/08/2016 13:48:42
//
...
namespace SharpTelegram.Schema
{
    ...
    public partial class TLSchemaAsyncMethods : ITLSchemaAsyncMethods
    {
        private readonly IRemoteProcedureCaller _remoteProcedureCaller;

        public TLSchemaAsyncMethods(IRemoteProcedureCaller remoteProcedureCaller)
        {
        ...
        public Task<IUpdates> MessagesSendBroadcastAsync(MessagesSendBroadcastArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IUpdates>(args);
        }
        ...
        public Task<IAccountSentChangePhoneCode> AccountSendChangePhoneCodeAsync(AccountSendChangePhoneCodeArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IAccountSentChangePhoneCode>(args);
        }
        ...
        public Task<IMessagesStickers> MessagesGetStickersAsync(MessagesGetStickersArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IMessagesStickers>(args);
        }
        ...
        public Task<System.Boolean> MessagesInstallStickerSetAsync(MessagesInstallStickerSetArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<System.Boolean>(args);
        }
        ...
        public Task<IHelpAppChangelog> HelpGetAppChangelogAsync(HelpGetAppChangelogArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IHelpAppChangelog>(args);
        }
        ...
        public Task<IMessagesDialogs> ChannelsGetDialogsAsync(ChannelsGetDialogsArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IMessagesDialogs>(args);
        }

        public Task<IMessagesMessages> ChannelsGetImportantHistoryAsync(ChannelsGetImportantHistoryArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IMessagesMessages>(args);
        }
        ...
        public Task<IUpdates> ChannelsToggleCommentsAsync(ChannelsToggleCommentsArgs args)
        {
            return _remoteProcedureCaller.RpcAsync<IUpdates>(args);
        }
